    ...
    return {
        ...
        updateUserCreatedProject : async (userId,projectDetails) => {
            try{
                ...
                console.log(e);
                throw new Error("User having Id : "+userId+" is not updated in user's created project profile");
        ...
        updateUserJoinedProject : async (userId,projectDetails) => {
            try{
                ...
                console.log(e);
                throw new Error("User having Id : "+userId+" is not updated in user's joined project profile");
            }
        }
